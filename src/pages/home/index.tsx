...
import { useGetAdvantageQuery, useGetBlogQuery } from "../../services/BlogService";
...
const Home = () => {
    ...
    const { data: blogData, isLoading: isBlogLoading } = useGetBlogQuery({
    ...
    return (
        <div>
            ...
            <Box sx={{ marginTop: promotion?.results.length ? 5 : 0 }}>
                ...
                <WrapperNewsSlider data={blogData} loading={isBlogLoading} />
