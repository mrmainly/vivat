        ...
        <div>
            <InfoBlog title="Оплата и получение заказа">
                <MyText variant="body2">
                    На сайте виват-аптека.рф для получения заказа необходимо
                    обратиться в аптеку, выбранную при оформлении заказа.
                </MyText>
                ...
                <ol>
                    <li style={{ fontSize: 14 }}>
                        <MyText variant="body2" sx={{ mt: 1.2 }}>
                            ...
                            Проверяете на месте комплектность, стоимость,
                            целостность, сроки годности, размер (для изделий
                            мед. назначения) каждой позиции заказа. В случае
                            несоответствия вы вправе отказаться от заказа.
                        </MyText>
                    </li>
                    <li style={{ fontSize: 14 }}>
                        <MyText variant="body2" sx={{ mt: 1.2 }}>
                            Оплачиваете на сайте и получаете заказ в аптеке. На
                            месте называете номер вашего заказа, далее
                            проверяете на месте комплектность, стоимость,
                            целостность, сроки годности, размер (для изделий
                            мед. назначения) каждой позиции заказа. В случае
                            несоответствия вы вправе отказаться от заказа.
                ...
                <Grid container sx={{ width: "70%", mt: 1.2, minHeight: 126 }}>
                    ...
                    >
                        <MyText>Каждый дополнительный км</MyText>
                    </Grid>
                    <Grid
                        item
                        xs={4}
                        sx={{ pl: 1.8, display: "flex", alignItems: "center" }}
                    >
                        <MyText>доставка в пределах 4 км</MyText>
                    </Grid>
                    <Grid
                        item
                        xs={4}
                    ...
                    >
                        <MyText>в отдаленные районы</MyText>
                    </Grid>
                    <Grid
                        item
                        xs={8}
                    ...
                    >
                        <MyText>рассчитывается индивидуально.</MyText>
                    </Grid>
                </Grid>
                <MyText variant="body2" sx={{ mt: 3.2 }}>
                    Оплата заказа производится онлайн на сайте в полном объеме
                    (выбираете при оформлении заказа. В счет заказа выставляется
                    цена на курьерскую доставку). При получении заказа
                    проверяйте на месте содержимое заказа.
                </MyText>
